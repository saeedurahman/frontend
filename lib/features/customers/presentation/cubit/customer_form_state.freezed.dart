...
class _$CustomerFormStateImpl implements _CustomerFormState {
  ...
  @override
  String toString() {
    return 'CustomerFormState(mode: $mode, customerId: $customerId, name: $name, phone: $phone, email: $email, addressLine1: $addressLine1, city: $city, creditLimit: $creditLimit, taxId: $taxId, isActive: $isActive, isLoading: $isLoading, isSubmitting: $isSubmitting, errors: $errors)';
  }
